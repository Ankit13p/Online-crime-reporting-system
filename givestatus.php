	...
	<div id="container" class="wrapper-container">
       ...
       <div class="corner-bottom-right">
		...
		<div class="contact_email">
		  <p>&nbsp;</p>
			<p><span class="componentheading"><em>give Status to the user:</em></span>
			<br></p>
			    <table width="596" height="290">
				 
				 <tr>
                    <td width="202" height="59" align="right"><br />
                      <span class="style15">Fir id:</span>
                      </label></td>
                  ...
                  <tr>
                    <td width="202" height="59" align="right"><br />
                      <span class="style15"> track of Fir:</span>
                      </label></td>
                    <td width="378"><span class="style15 style3">&nbsp;
                      <select name="officer" class="list"  id="officer"  >
                        <option >-------select-------</option>						
                        <?php
					  $officerQuery = "select status_desc from status";
					 $rsOfficer = mysqli_query($conn,$officerQuery);
					while($rowOfficer = mysqli_fetch_array($rsOfficer))
					  {
						  ?>
                        <option value="<?php echo $rowOfficer['status_desc']?>"> <?php echo $rowOfficer['status_desc']?></option>
                        <?php }?>
                        <script type="text/javascript">
				          //var f1 = new LiveValidation('officer');
				          //f1.add(Validate.Presence,{failureMessage: "Please enter officer name"});				   
