...
?>
        ...
        <form action="chkFIRreg3.php" method="post" enctype="multipart/form-data" name="form1">
		 <div>
		   <h1>Step:3. &nbsp; Fill &nbsp; the &nbsp; following &nbsp; FIR &nbsp; details</h1>
		   <h2><span class="componentheading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Information about victim):</span>
		     </h2>
		 </div>             
           <p>&nbsp;</p>
           <table width="770" height="323" border="0" align="center" cellpadding="10" cellspacing="5">
             ...
             <tr bgcolor="#993366">
               <td height="46" align="right" valign="middle" bgcolor="#FFFFFF"><span class="style3">City:</span></td>
               <td align="left" bgcolor="#FFFFFF"><span class="style15 style3">
             ...
             <tr bgcolor="#993366">
               <td align="right" valign="middle" bgcolor="#FFFFFF"><span class="style3">Email-id:</span>             
               <td align="left" bgcolor="#FFFFFF">
